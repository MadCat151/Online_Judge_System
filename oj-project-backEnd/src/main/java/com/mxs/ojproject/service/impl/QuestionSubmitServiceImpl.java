...
import com.mxs.ojproject.judge.JudgeService;
import com.mxs.ojproject.mapper.QuestionSubmitMapper;
...
/**
 * @author Lenovo
 * @description 针对表【question_submit(Question submission table)】的数据库操作Service实现
...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit>
    ...
    public long doQuestionSubmit(QuestionSubmitAddRequest questionSubmitAddRequest, User loginUser) {
        ...
        //long userId = 1835768930593959938;
        // 每个用户串行提交题目
